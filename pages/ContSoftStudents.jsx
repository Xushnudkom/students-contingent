...
const ContSoftStudents = () => {
  return (
    <div className="container mx-auto px-20 pb-8">
      ...
      <div>
        <p className="text-blue-950 text-2xl font-semibold">
          Software Engineering
        </p>
        <div className="1-kurs">
          <div className="flex items-center pt-4">
            <h1 className="text-2xl font-semibold text-blue-950 w-[300px]">
              1st year students
            </h1>
          ...
          <div className="1-kurs-group pt-8 flex justify-between">
            <Link
              href="#"
              className="bg-gray-100 p-4 hover:bg-gray-300 transition duration-300 shadow-xl text-blue-950 text-xl rounded-xl"
            >
              310-25
            </Link>
            <Link
